...
public class PatronValidator : Validator<Patron>
{
    ...
    {
        Validations.Add("Name is required and must only contain alphabetic characters.", patron => !string.IsNullOrEmpty(patron.Name) && patron.Name.All(c => char.IsLetter(c) || char.IsWhiteSpace(c)));
